...
export const ContentPlanetas = () => {
  ...
  const { store, actions } = useContext(Context);
    ...
    return (
        ...
        <div className="row">
            <h2>Planetas</h2>
            {store.listaPlanetas.map((item,id)=> <div className="card"  key={id} style={{width:"18rem"}}>
            <img style={{  objectFit: "cover" }} src={`https://starwars-visualguide.com/assets/img/planets/${id+1}.jpg`} className="card-img-top " alt="..." />
